...
export const metadata: Metadata = {
  ...
  description: 'GM Groups - The powerhouse of Xlantis. Dominating business, streets, and luxury. Join the elite network of GM Cafe, GM Industries, and more.',
  keywords: ['GM Groups', 'Xlantis', 'RP', 'GM Cafe', 'Roleplay', 'Business', 'Gang', 'GTA V', 'FiveM', 'Gaming Community'],
